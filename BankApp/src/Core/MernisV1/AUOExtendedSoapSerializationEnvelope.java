...
public class AUOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AUODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AUOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AUODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AUODateTimeConverter dateTimeConverter = new AUOStandardDateTimeConverter();

    public AUOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AUOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AUOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AUOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AUOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AUOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
