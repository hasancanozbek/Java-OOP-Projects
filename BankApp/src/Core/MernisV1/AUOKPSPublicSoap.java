...
public class AUOKPSPublicSoap
{
    ...
    public AUOKPSPublicSoap(){}

    public AUOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AUOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AUOExtendedSoapSerializationEnvelope envelope= new AUOExtendedSoapSerializationEnvelope(AUOExtendedSoapSerializationEnvelope.VER11);
