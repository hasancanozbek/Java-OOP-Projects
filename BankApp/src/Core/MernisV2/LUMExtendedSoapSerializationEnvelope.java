...
public class LUMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LUMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LUMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LUMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LUMDateTimeConverter dateTimeConverter = new LUMStandardDateTimeConverter();

    public LUMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LUMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LUMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LUMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LUMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LUMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
