...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        account1.setCustomerTC("12770350780"); //Gerçek bir tc kimlik numarası girin
        account1.setCustomerBirthOfYear(2001);
        account1.setAccountId("12770350780");
        account1.setBalance(1000);

        IndividualAccount account2 = new IndividualAccount("01010101010","İbrahim","Özbek","23593989378",1968,5000);
        /*
