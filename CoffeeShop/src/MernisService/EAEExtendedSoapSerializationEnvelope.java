...
public class EAEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EAEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EAEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EAEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EAEDateTimeConverter dateTimeConverter = new EAEStandardDateTimeConverter();

    public EAEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EAEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EAEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EAEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EAEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EAEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
