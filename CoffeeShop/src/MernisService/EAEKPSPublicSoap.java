...
public class EAEKPSPublicSoap
{
    ...
    public EAEKPSPublicSoap(){}

    public EAEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EAEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EAEExtendedSoapSerializationEnvelope envelope= new EAEExtendedSoapSerializationEnvelope(EAEExtendedSoapSerializationEnvelope.VER11);
