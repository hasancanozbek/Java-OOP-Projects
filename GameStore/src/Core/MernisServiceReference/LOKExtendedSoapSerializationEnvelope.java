...
public class LOKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LOKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LOKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LOKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LOKDateTimeConverter dateTimeConverter = new LOKStandardDateTimeConverter();

    public LOKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LOKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LOKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LOKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LOKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LOKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
