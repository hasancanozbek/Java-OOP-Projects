...
public class LOKKPSPublicSoap
{
    ...
    public LOKKPSPublicSoap(){}

    public LOKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LOKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LOKExtendedSoapSerializationEnvelope envelope= new LOKExtendedSoapSerializationEnvelope(LOKExtendedSoapSerializationEnvelope.VER11);
