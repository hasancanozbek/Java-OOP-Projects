...
public class CTPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CTPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CTPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CTPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CTPDateTimeConverter dateTimeConverter = new CTPStandardDateTimeConverter();

    public CTPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CTPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CTPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CTPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CTPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CTPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
