...
public class CTPKPSPublicSoap
{
    ...
    public CTPKPSPublicSoap(){}

    public CTPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CTPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CTPExtendedSoapSerializationEnvelope envelope= new CTPExtendedSoapSerializationEnvelope(CTPExtendedSoapSerializationEnvelope.VER11);
